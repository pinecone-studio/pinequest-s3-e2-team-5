...
//#endregion
//#region node_modules/@clerk/nextjs/dist/esm/utils/sdk-versions.js
function meetsNextMinimumVersion(minimumMajorVersion) {
	var _a;
	if (!((_a = package_default) == null ? void 0 : _a.version)) return false;
	const majorVersion = parseInt(package_default.version.split(".")[0], 10);
	return !isNaN(majorVersion) && majorVersion >= minimumMajorVersion;
}
var isNext16OrHigher = meetsNextMinimumVersion(16);
var middlewareFileReference = isNext16OrHigher ? "middleware or proxy" : "middleware";
//#endregion
export { middlewareFileReference as n, package_default as r, isNext16OrHigher as t };
